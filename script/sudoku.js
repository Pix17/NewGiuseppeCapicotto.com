...
function verifica() {
  ...
  for (let i = 0; i < tabella.length; i++) {
    for (let j = 0; j < tabella.length; j++) {
      for (let k = j + 1; k < tabella.length; k++) {
        if (
          document.getElementById(tabella[i][j]).value ==
          document.getElementById(tabella[i][k]).value
        ) {
  ...
  for (let i = 0; i < tabella.length; i++) {
    for (let j = 0; j < tabella.length; j++) {
      for (let k = j + 1; k < tabella.length; k++) {
        if (
          document.getElementById(tabella[j][i]).value ==
          document.getElementById(tabella[k][i]).value
        ) {
